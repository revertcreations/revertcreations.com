<x-layout>
    <div class="contract-wrap">
        ...
        <p>
            ...
            of this Event type photoshoot session contract, hereinafter referred to as the &quot;
            <strong>Client</strong>&quot;, collectively referred to as the &quot;
            <strong>Parties</strong>&quot;. The Parties complete agreement and obligations are contained
        ...
        <p>
            ...
            on a backup storage for 1 year, after which the Photographer cannot guarantee the retrieval of them.
        </p>

        <h3>Fees</h3>
        <p>
            In consideration for the photography services provided by the Photographer, the Client agrees to pay
            $150. The Photographer agrees to not advertise the availability of this same time slot to any other
            ...
            Photographer, 30% of the original payment due will be charged as a late fee. The payment can be accepted
            via cash, Venmo, PayPal, Facebook Payment, or Chase QuickPay.
        </p>

        <h3>Retainer</h3>
        <p>
            A retainer fee of $0 is required for the shoot and due by 2 weeks prior to the day of the event. This is
