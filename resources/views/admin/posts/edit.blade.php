<x-admin-layout>
    ...
    <main>
        <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8 space-y-10">
            ...
            <form method="POST" action="{{ route('admin.posts.update', $post) }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        Upload a blog asset and we&rsquo;ll give you a markdown snippet you can paste into the content.
                    </p>
            ...
            <form method="POST" action="{{ route('admin.posts.destroy', $post) }}" class="flex justify-end">
                @csrf
                @method('DELETE')
                <button type="submit"
