                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a target="_blank" href="{{ route('photography.proposal', ['proposal' => $proposal->id, 'token' => $proposal->public_token]) }}" class="text-indigo-600 hover:text-indigo-900">Preview</a>
                                        </td>
