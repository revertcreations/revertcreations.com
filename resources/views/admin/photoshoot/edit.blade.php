                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px-0">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Upload Images</h3>
                        </div>

                        <form action="{{ route('images.store', ['photoshoot' => $photoshoot->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="shadow overflow-hidden sm:rounded-md">
                                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <h2>{{ $photoshoot->client->first_name }} {{ $photoshoot->client->last_name }}</h2>
                                    </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            ...
                                            <input value="{{ $photoshoot->contract->late_fee_percent }}" type="number" name="late_fee" id="late_fee" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            ...
                                            <input value="{{ $photoshoot->contract->price_per_image }}" type="number" name="price_per_image" id="price_per_image" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        ...
                                        <div class="mt-1 flex rounded-md shadow-sm">
                                            ...
                                            <input value="{{ $photoshoot->contract->delivered_images_count }}" type="number" name="delivered_images_count" id="delivered_images_count" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="arrival_at" id="arrival_at" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
