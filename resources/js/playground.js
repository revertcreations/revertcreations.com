const Playground = {
    ...
    homepageTag: document.querySelector("text-puzzle-element"),
    ...
    attachResizeListener: () => {
        ...
        Playground.resizeListener = () => {
            ...
            Playground.resizeTimeoutId = window.setTimeout(() => Playground.reset("resize"), 1000);
        };
    ...
    reset: (mode) => {
        ...
        if (
            ...
            typeof Playground.activeSkill.element.releasePointerCapture === "function" &&
        ...
        for (let skill in Playground.skills) {
            ...
            if (Playground.skills[skill].element) {
                ...
                if (
                    ...
                    Playground.skills[skill].element.parentNode === Playground.playground
                ) {
    ...
    dragStart: (e) => {
        ...
        Playground.dropZoneRect =
            Playground.homepageTag && Playground.homepageTag.getBoundingClientRect();
    ...
    dragEnd: (e) => {
        const skill = Playground.activeSkill || Playground.getSkillBasedOnName(e.target?.id);
    ...
    draggingEvents: (e, skill) => {
        ...
        const dropZoneRect =
            Playground.dropZoneRect || Playground.homepageTag.getBoundingClientRect();
    ...
    buildInfoCardCloseElement: (skill) => {
        ...
        skill.closeButtonHandler = () => Playground.closeInfoCard(skill.name);
