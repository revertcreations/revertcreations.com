...
(function () {
  ...
  if (camera_icon) camera_icon.addEventListener('mouseover', function (el) {
    ...
    el.target.innerHTML = '&#128248;';
    var camera_icon_flash = setTimeout(function () {
      el.target.innerHTML = '&#128247;';
    }, 200, el);
  });
  if (computer_icon) computer_icon.addEventListener('mouseover', function (el) {
  ...
  if (photographer) {
    photographer.addEventListener('click', function (el) {
      ...
      var photographer_info = document.getElementById('photographer_info');
      var photographer_timeout = setTimeout(function () {
  ...
  if (document.getElementById('event_ends')) var event_ends = window.flatpickr(document.getElementById('event_ends'), {
    enableTime: true,
    dateFormat: "Y-m-d H:i"
  });
