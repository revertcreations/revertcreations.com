...
class SkillSeeder extends Seeder
{
    ...
    public function run()
    {
        $skills = collect([
            ...
            ['name' => 'README.md', 'experience' => 100, 'excerpt' => "<p class='m-4 max-w-xs align-top  md:self-start self-center'>Over the past 7+ years, 5 of which spent building ticketing software with the great people at<span class='bg-hmt-green underline font-bold text-xl'><a href='https://tickets.holdmyticket.com'>HoldMyTicket</a></span>,I've gained a lot of confidence in many technologies, languages, and software. These are the tools thathelp me quickly build interactive, responsive, and secure web applications. Some I am just now learning, and othersI've been hacking with for years.</p>"],
