    ...
    public function run(): void
    {
        ...
        $opportunities = [
            ...
            [
                ...
                'links' => [
                    'ops_playbook' => 'docs/launch/ops-infrastructure',
                ],
            ],
            [
                ...
                'links' => [
                    'catalog_plan' => 'docs/vehicle_data_expansion',
                ],
            ],
            [
                ...
                'links' => [
                    'typesafe_notes' => 'docs/qa/mobile-regression-plan',
                ],
            ],
        ];
        ...
        $activities = [
            [
                ...
                'link' => 'docs/launch/ops-infrastructure',
                'tags' => ['backend', 'ingest'],
                'public_visibility' => true,
            ],
            [
            ...
            [
                ...
                'link' => 'docs/launch/infra-provisioning-checklist',
                'tags' => ['infra', 'ci'],
                'public_visibility' => true,
            ],
            [
            ...
            [
                ...
                'link' => 'docs/launch/backup-restore-verification',
                'tags' => ['infra', 'launch'],
                'public_visibility' => true,
            ],
            [
                ...
                'link' => 'docs/qa/regression-2025-09-30',
                'tags' => ['qa', 'launch'],
                'public_visibility' => true,
            ],
            [
        ...
        $buildLogs = [
            ...
            [
                ...
                'links' => [
                    'notification_plan' => 'docs/qa/manual-regression-checklist',
                ],
                'public_visibility' => true,
            ],
            [
                ...
                'links' => [
                    'decision_log' => 'docs/launch/decision-log',
                    'infra_checklist' => 'docs/launch/infra-provisioning-checklist',
                ],
                'public_visibility' => true,
            ],
            [
                ...
                'links' => [
                    'admin_briefing' => 'docs/launch/pod-briefings',
                ],
                'public_visibility' => true,
            ],
            [
                ...
                'links' => [
                    'billing_plan' => 'docs/monetization',
                ],
                'public_visibility' => true,
            ],
            [
                ...
                'links' => [
                    'ui_notes' => 'docs/notes/push-notification-resume-investigation',
                ],
                'public_visibility' => true,
            ],
            [
                ...
                'links' => [
                    'decision_log' => 'docs/launch/decision-log',
                    'backup_plan' => 'docs/launch/backup-restore-verification',
                    'secret_rotation' => 'docs/launch/secret-rotation-plan',
                    'dns_cutover' => 'docs/launch/dns-cutover-plan',
                ],
                'public_visibility' => true,
            ],
            [
                ...
                'links' => [
                    'regression_log' => 'docs/qa/regression-2025-09-30',
                    'app_store_prep' => 'docs/launch/app-store-prep',
                    'screenshot_plan' => 'docs/launch/screenshot-fixture',
                ],
                'public_visibility' => true,
            ],
            [
